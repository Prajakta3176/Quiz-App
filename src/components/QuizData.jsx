  ...
  return (
    <>
      <div className="quizeHeader2">
            <div className='questionNumberContainer'><p className="quizTimer">Question : {currentQuestion + 1}</p></div>
            <div className='timerContainer'><p className="quizTimer">Time Left : {timeRemaining}s</p></div>
      </div>
